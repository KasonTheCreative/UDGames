...
export function FollowMe() {
  useEffect(() => {
    ...
    // Reinitialize Instagram embeds if script already loaded
    if (window.instgrm) {
      ...
      <main className="container mx-auto px-4 py-12">
        <div className="mb-12 text-center">
          <div className="mb-4 flex justify-center">
            <div className="rounded-full bg-gradient-to-r from-purple-500 via-pink-500 to-orange-500 p-4">
              <Instagram className="h-12 w-12 text-white" />
            </div>
          </div>
          <h1 className="mb-2 text-5xl font-black gradient-text">Follow Me!</h1>
          <p className="text-muted-foreground text-lg">
            Check out my Instagram for awesome content
          </p>
        </div>
        ...
        <div className="flex justify-center">
          <div className="w-full max-w-xl">
            <blockquote 
              ...
              data-instgrm-permalink="https://www.instagram.com/best.of.bruins/?utm_source=ig_embed&utm_campaign=loading" 
            ...
            >
              <div style={{ padding: '16px' }}>
                <a 
                  href="https://www.instagram.com/best.of.bruins/?utm_source=ig_embed&utm_campaign=loading" 
                  style={{ 
                    background: '#FFFFFF', 
                    lineHeight: 0, 
                    padding: '0 0', 
                ...
                <p style={{ color: '#c9c8cd', fontFamily: 'Arial,sans-serif', fontSize: '14px', lineHeight: '17px', marginBottom: 0, marginTop: '8px', overflow: 'hidden', padding: '8px 0 7px', textAlign: 'center', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>
                  <a href="https://www.instagram.com/best.of.bruins/?utm_source=ig_embed&utm_campaign=loading" style={{ color: '#c9c8cd', fontFamily: 'Arial,sans-serif', fontSize: '14px', fontStyle: 'normal', fontWeight: 'normal', lineHeight: '17px' }} target="_blank" rel="noopener noreferrer">
                    Best of Bruins
                  </a> (@
                  <a href="https://www.instagram.com/best.of.bruins/?utm_source=ig_embed&utm_campaign=loading" style={{ color: '#c9c8cd', fontFamily: 'Arial,sans-serif', fontSize: '14px', fontStyle: 'normal', fontWeight: 'normal', lineHeight: '17px' }} target="_blank" rel="noopener noreferrer">
                    best.of.bruins
        ...
        <div className="mt-12 text-center">
          <div className="glass-card max-w-2xl mx-auto p-8">
            <h2 className="text-2xl font-bold gradient-text mb-4">Stay Connected</h2>
            <p className="text-muted-foreground mb-6">
              Follow @best.of.bruins on Instagram for the latest updates, highlights, and exclusive content!
            </p>
            <a 
              href="https://www.instagram.com/best.of.bruins/" 
              target="_blank" 
              rel="noopener noreferrer"
